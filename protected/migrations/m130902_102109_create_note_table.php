...
class m130902_102109_create_note_table extends CDbMigration
{
	...
	public function safeUp()
	{
		...
		$this->addForeignKey("fk_note_user","tbl_note", "user_id","tbl_user","id","RESTRICT","RESTRICT");
		$this->addForeignKey("fk_note_update_user","tbl_note", "update_user_id","tbl_user","id","RESTRICT","RESTRICT");
	}
