 ...
 */
class Type extends WraperActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, caption, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'furnitures' => array(self::HAS_MANY, 'Furniture', 'type_id'),
		);
	}
	...
	{
		$types = CHtml::listData($this->type, 'id', 'type');
	    return $types;
	} 
}